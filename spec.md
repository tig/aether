...
| Face shape | **Square** panel; **rounded-square** inner aperture; segment radial length varies so the **outer** edge hits the square (long toward corners / top-left ~AFR 12) — flush left / top / right |
