...
| **Implementation epics** | P0 host MSQ/ATM library → P1 live read firmware → P2 write gates → P3 agent loop |
...
| [docs/research/map-formats.md](../docs/research/map-formats.md) | Survey detail |
